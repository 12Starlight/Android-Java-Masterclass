...
public class Comparisons {
    public static void main(String[] args) { // psvm tab
        ...
        System.out.println(greeting == greeting2); // do not use == when testing strings
        System.out.println(greeting.equals(greeting2)); // str1.equals(str2) when testing strings
    }
}
